...
pub const TECHNIQUES: &[Technique] = &[
    ...
    Technique {
        id: "T1564.004",
        name: "Hidden File System - Memory",
        tactic: Tactic::DefenseEvasion,
    ...
    Technique {
        id: "T1055",
        name: "Process Injection (Polymorphic)",
        tactic: Tactic::DefenseEvasion,
    ...
    Technique {
        id: "T1552.001",
        name: "Credentials from Files (SSH Keys)",
    ...
    Technique {
        id: "T1552.004",
        name: "Credentials from Files (Cloud Keys)",
        tactic: Tactic::CredentialAccess,
    ...
    Technique {
        id: "T1552.002",
        name: "Credentials in Files (.bash_history)",
        tactic: Tactic::CredentialAccess,
    ...
    Technique {
        id: "T1570",
        name: "Lateral Tool Transfer (SCP)",
        tactic: Tactic::LateralMovement,
    ...
    Technique {
        id: "T1573.002",
        name: "Encrypted Channel (ChaCha20)",
    ...
    Technique {
        id: "T1204.002",
        name: "User Execution: Malicious File (Dropper)",
    ...
    Technique {
        id: "T1543.002",
        name: "Create or Modify System Process (systemd)",
    ...
    Technique {
        id: "T1547.001",
        name: "Boot or Logon Autostart (reboot survival)",
        tactic: Tactic::Persistence,
...
pub fn generate_coverage_report() -> String {
    ...
    report.push_str(&format!(
        "Coverage: {:.1}% of enterprise matrix\n",
        coverage_pct
    ));
...
mod tests {
    ...
    fn test_tactics_have_techniques() {
        ...
        assert!(
            evasion.len() >= 5,
            "Should have at least 5 evasion techniques"
        );
    }
